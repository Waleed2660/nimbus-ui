...
const displayLoadingAnimation = () => {
  return (
    <div class="flex items-center justify-center min-h-screen w-full ml-80">
      <svg aria-hidden="true" class="w-10 h-10 animate-spin fill-green-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
